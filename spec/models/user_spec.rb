...
RSpec.describe User, type: :model do
  ...
  it 'メールアドレスが255字であれば有効であること' do
    user = FactoryBot.build(:user, email: "nbvniewUJBSpsodnvcdsoivvprep9posjrij_vgifvkf439urtgjioerminfvnbhiejonvijcoijeoijigjronvi.rejiovflodmvopjreojospiwwei49gjirmvodfDISVNSNCfdcmeoproie9mbfkmmcdlsOISFNmopqwjireritu8bhfiuhdsporgfri509-69jncnheugvfdnlkdmnvkldfgmljkvmdslkvkdfjsvjFIEJI@example.com")
    user.valid?
    expect(user).to be_valid
  end

  it 'メールアドレスが254字であれば有効であること' do
    user = FactoryBot.build(:user, email: "nbvniewUJBSpsodnvcdsoivvprep9posrij_vgifvkf439urtgjioerminfvnbhiejonvijcoijeoijigjronvi.rejiovflodmvopjreojospiwwei49gjirmvodfDISVNSNCfdcmeoproie9mbfkmmcdlsOISFNmopqwjireritu8bhfiuhdsporgfri509-69jncnheugvfdnlkdmnvkldfgmljkvmdslkvkdfjsvjFIEJI@example.com")
    user.valid?
    expect(user).to be_valid
  end

  it 'メールアドレスが256字であれば無効であること' do
    user = FactoryBot.build(:user, email: "nbvniewUJBSpsodQnvcdsoivvprep9posjrij_vgifvkf439urtgjioerminfvnbhiejonvijcoijeoijigjronvi.rejiovflodmvopjreojospiwwei49gjirmvodfDISVNSNCfdcmeoproie9mbfkmmcdlsOISFNmopqwjireritu8bhfiuhdsporgfri509-69jncnheugvfdnlkdmnvkldfgmljkvmdslkvkdfjsvjFIEJI@example.com")
    user.valid?
